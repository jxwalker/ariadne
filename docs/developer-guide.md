...
- `src/liveAdapterOperatorEvidenceCheckAll.ts`: batch preflight over every target template; writes an aggregate report and refreshes the queue without recording evidence.
