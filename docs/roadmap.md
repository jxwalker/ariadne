...
- live adapter operator-evidence drafts that turn the next-packet human verification worksheet into non-authoritative candidate review notes without touching `operator-evidence.md`, importing evidence, or granting approval
