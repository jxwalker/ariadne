...
Project: ariadne
Target: deployment
Title: Atlas qwen3.6 canary runtime evidence
...
- Parsed sources: 1
- Redacted values: 1
- Notes: Fast Atlas endpoint qwen3.6-35b-a3b-nvfp4-atlas responded to the read-only canary. Raw endpoint URL remains local-only and redacted from promoted evidence.

## Sources

| Source | Kind | Parsed | Bytes | SHA-256 | Redactions |
| --- | --- | --- | ---: | --- | ---: |
| projects/ariadne/infrastructure/runtime/local-runtime-probe-2026-05-18T08-27-34-611Z.json | local-runtime-probe | true | 5325 | d9eee5f043394a05ad9f04e7f393d2405ba004725ebd8971336587e84c6c9067 | 1 |
...
```json
{
  "generatedAt": "2026-05-18T08:27:34.611Z",
