...
Project: ariadne
Target: deployment
Title: Latest Atlas Qwen runtime and smoke evidence
...
- Parsed sources: 2
- Redacted values: 2
- Notes: Read-only Atlas qwen3.6-35b-a3b-nvfp4-atlas runtime canary plus e2e smoke after healer automation gates; promotion remains review-only and redacted.

## Sources

| Source | Kind | Parsed | Bytes | SHA-256 | Redactions |
| --- | --- | --- | ---: | --- | ---: |
| projects/ariadne/infrastructure/runtime/local-runtime-probe-2026-05-18T07-53-15-604Z.json | local-runtime-probe | true | 5325 | 46c80305cfd03a80fda5f1b7958f5ecb71bb5c3b2a9359245851497730ce6340 | 1 |
| projects/ariadne/evaluation/e2e-smoke-2026-05-18T07-53-15-587Z.json | e2e-smoke | true | 5685 | cbd3fe90f95f0efdf79deb05db6427085dae97a0804d5f0d6363c02a3935d5ce | 1 |
...
```json
{
  "generatedAt": "2026-05-18T07:53:15.604Z",
...
```json
{
  "generatedAt": "2026-05-18T07:53:15.587Z",
  "status": "blocked",
  "summary": {
    "steps": 13,
    "passed": 11,
  ...
  "steps": [
    ...
    {
      "status": "blocked",
      "detail": "3 roadmap blocker(s), 40 GBrain document(s), next target deployment."
    }
  ]
}
```
