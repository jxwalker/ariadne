...
Generated: 2026-05-17T06:04:26.655Z
...
| --- | --- | --- | --- |
| Fill and import operator evidence | pending | The target has no imported operator evidence record. Fill the generated template with real observations before packet review or cutover. | npm run ariadne -- live-adapter-operator-evidence --project <project> --target github --from vault/projects/<project>/control/live-adapter-evidence-templates/live-adapter-evidence-template-github.md --by <operator> |
...
| Action | Status | Rationale | Command |
| --- | --- | --- | --- |
| Fill and import operator evidence | pending | The target has no imported operator evidence record. Fill the generated template with real observations before packet review or cutover. | npm run ariadne -- live-adapter-operator-evidence --project <project> --target deployment --from vault/projects/<project>/control/live-adapter-evidence-templates/live-adapter-evidence-template-deployment.md --by <operator> |
| Record operator review of the approval packet | pending | Before a live adapter can replace placeholder shell commands, an operator must review the target packet and record whether the packet is accepted, rejected, or needs changes. This does not approve live mutation. | npm run ariadne -- live-adapter-approval-review --project <project> --target deployment --by <operator> --status accepted --packet control/live-adapter-approval-pack.json --evidence <operator-review-evidence> |
| Record an operator approval request | pending | Live adapters need explicit human authorization before any target-specific readiness plan can be treated as reviewable. | npm run ariadne -- approval-request --project <project> --by <operator> --target deployment --action "<bounded action>" --risk <low\|medium\|high> --reason "<why this target should mutate>" --rollback "<operator rollback path>" --evidence <auth-or-policy-evidence> |
...
| Action | Status | Rationale | Command |
| --- | --- | --- | --- |
| Fill and import operator evidence | pending | The target has no imported operator evidence record. Fill the generated template with real observations before packet review or cutover. | npm run ariadne -- live-adapter-operator-evidence --project <project> --target hermes-cron --from vault/projects/<project>/control/live-adapter-evidence-templates/live-adapter-evidence-template-hermes-cron.md --by <operator> |
...
| Action | Status | Rationale | Command |
| --- | --- | --- | --- |
| Fill and import operator evidence | pending | The target has no imported operator evidence record. Fill the generated template with real observations before packet review or cutover. | npm run ariadne -- live-adapter-operator-evidence --project <project> --target openscorpion --from vault/projects/<project>/control/live-adapter-evidence-templates/live-adapter-evidence-template-openscorpion.md --by <operator> |
...
| Action | Status | Rationale | Command |
| --- | --- | --- | --- |
| Fill and import operator evidence | pending | The target has no imported operator evidence record. Fill the generated template with real observations before packet review or cutover. | npm run ariadne -- live-adapter-operator-evidence --project <project> --target gsd2 --from vault/projects/<project>/control/live-adapter-evidence-templates/live-adapter-evidence-template-gsd2.md --by <operator> |
...
| Action | Status | Rationale | Command |
| --- | --- | --- | --- |
| Fill and import operator evidence | pending | The target has no imported operator evidence record. Fill the generated template with real observations before packet review or cutover. | npm run ariadne -- live-adapter-operator-evidence --project <project> --target notebooklm --from vault/projects/<project>/control/live-adapter-evidence-templates/live-adapter-evidence-template-notebooklm.md --by <operator> |
