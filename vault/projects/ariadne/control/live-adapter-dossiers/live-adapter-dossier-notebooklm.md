...
- pending: Fill and import operator evidence - npm run ariadne -- live-adapter-operator-evidence --project <project> --target notebooklm --from vault/projects/<project>/control/operator-evidence/notebooklm/operator-evidence.md --by <operator>
