# Live Adapter Target Dossier: hermes-cron
...
- pending: Prepare, fill, and import operator evidence - npm run ariadne -- live-adapter-operator-evidence-next --project <project> --target hermes-cron
