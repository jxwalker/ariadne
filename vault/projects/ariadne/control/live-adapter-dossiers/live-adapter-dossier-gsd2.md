...
- pending: Fill and import operator evidence - npm run ariadne -- live-adapter-operator-evidence --project <project> --target gsd2 --from vault/projects/<project>/control/live-adapter-evidence-templates/live-adapter-evidence-template-gsd2.md --by <operator>
