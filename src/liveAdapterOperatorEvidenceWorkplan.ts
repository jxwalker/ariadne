...
function workplanTarget(
  ...
  return {
    ...
    checkCommand: `npm run ariadne -- live-adapter-operator-evidence-check --project ${project} --target ${auditTarget.target} --from vault/projects/${project}/control/live-adapter-evidence-templates/live-adapter-evidence-template-${auditTarget.target}.md`,
