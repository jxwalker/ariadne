...
const ARTIFACT_SPECS: ArtifactSpec[] = [
  ...
  },
  {
    ...
    label: "Mutation readiness repair plan",
    required: false,
    kind: "file",
    relativePath: "control/mutation-readiness-repair-plan.json"
  },
  {
  ...
  {
    id: "live-adapter-operator-evidence-checks",
    label: "Live adapter operator evidence checks",
    required: false,
    kind: "matching-files",
    relativePath: "control/live-adapter-operator-evidence-checks",
    prefix: "operator-evidence-check-",
    suffix: ".json",
    minimumCount: 1
  },
  {
  ...
  },
  {
    ...
    label: "Live adapter operator evidence workplan",
    required: false,
    kind: "file",
  ...
  {
    id: "live-adapter-operator-evidence-next",
    label: "Live adapter next operator packet",
    required: false,
    kind: "matching-files",
    relativePath: "control",
    prefix: "live-adapter-operator-evidence-next-",
    suffix: ".json",
    minimumCount: 1
  },
  {
  ...
  },
  {
    ...
    required: false,
    kind: "matching-files",
    relativePath: "control/operator-evidence",
    prefix: "",
    suffix: ".md",
    minimumCount: 6,
    recursive: true
